    ...
    <div>
      ...
      <div tabIndex={0} role="button" className="pr-4 cursor-pointer group">
        <div className="indicator">
          ...
          {cart.length>0 && <span className="badge badge-sm bg-myOrange font-semibold indicator-item text-myBlackHead group-hover:text-myWhite group-hover:bg-myBlackPara duration-300">{cart.length}</span>}
        </div>
      </div>
      </Link>
    </div>
